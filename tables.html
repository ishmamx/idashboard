          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">General Table</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#general-table"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="general-table">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">General Table</h5>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">Table head options</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#Table-head-options"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="Table-head-options">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Table head options</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              ...
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#stripedRows"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="stripedRows">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Striped rows</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">Bordered table</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#BorderedTable"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="BorderedTable">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Bordered table</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">Borderless table</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#BorderlessTable"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="BorderlessTable">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Borderless table</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
                      <div class="modal-body">
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-borderless"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;thead&gt;</span>
    <span class="nt">&lt;tr&gt;</span>
      <span class="nt">&lt;th</span> <span class="na">scope=</span><span class="s">"col"</span><span class="nt">&gt;</span>#<span class="nt">&lt;/th&gt;</span>
      <span class="nt">&lt;th</span> <span class="na">scope=</span><span class="s">"col"</span><span class="nt">&gt;</span>First<span class="nt">&lt;/th&gt;</span>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              ...
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#HoverableRows"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="HoverableRows">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Hoverable rows</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">Small table</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#Small-table"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="Small-table">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Small table</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
                      <div class="modal-body">
<figure class="highlight"><pre><code class="language-html" data-lang="html"><span class="nt">&lt;table</span> <span class="na">class=</span><span class="s">"table table-sm"</span><span class="nt">&gt;</span>
  <span class="nt">&lt;thead&gt;</span>
    <span class="nt">&lt;tr&gt;</span>
      <span class="nt">&lt;th</span> <span class="na">scope=</span><span class="s">"col"</span><span class="nt">&gt;</span>#<span class="nt">&lt;/th&gt;</span>
      <span class="nt">&lt;th</span> <span class="na">scope=</span><span class="s">"col"</span><span class="nt">&gt;</span>First<span class="nt">&lt;/th&gt;</span>
...
<span class="nt">&lt;/table&gt;</span></code></pre></figure>
          ...
          <div class="yoo-card yoo-style1">
            <div class="yoo-card-heading">
              <div class="yoo-card-heading-left">
                <h2 class="yoo-card-title">Contextual classes</h2>
              </div>
              <div class="yoo-card-heading-right">
                <button type="button" class="yoo-card-btn" data-toggle="modal" data-target="#Contextual-classes"><ion-icon name="code"></ion-icon></button>
                <!-- Code Modal -->
                <div class="modal fade" id="Contextual-classes">
                  <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title">Contextual classes</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                          <ion-icon name="close"></ion-icon>
                        </button>
                      </div>
